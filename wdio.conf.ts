...
export const config: Options.Testrunner = {
    ...
    //
    specs: ['./test/functional/features/elisetest.feature'],
    // Patterns to exclude.
    exclude: [
    ...
    capabilities: [
        ...
        { browserName: 'chrome',
            'goog:chromeOptions': {
                ...
                "prefs": {
                    ...
                    'download.default_directory': path.join(__dirname, '../../fileDownloads/'),
        ...
        //     'browser.helperApps.neverAsk.saveToDisk': 'text/plain, application/octet-stream, text/x-c'
        //   },
        // },
    // },
   // If outputDir is provided WebdriverIO can capture driver session logs
    ...
    // baseUrl: "https://apps.gktest.nupano-dev.com/create-container-app",
    //
    ...
    cucumberOpts: {
        ...
        require: ['./test/functional/stepDefinitions/*.steps.ts'],
